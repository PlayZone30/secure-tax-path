...
// Same hardcoded blog articles data (in a real app, this would come from an API or CMS)
const blogArticles = [
  {
    id: 1,
        ...
        <div className="max-w-4xl mx-auto">
                  ...
                  <Card key={relatedArticle.id} className="group hover:shadow-lg transition-shadow">
                    <CardContent className="p-6">
                      <div className="flex items-center gap-2 mb-3">
                        <Badge variant="secondary" className="text-xs">{relatedArticle.category}</Badge>
                      </div>
                      <h3 className="font-semibold text-gray-900 mb-2 group-hover:text-primary transition-colors line-clamp-2">
                        <Link to={`/blog/${relatedArticle.id}`} className="hover:underline">
          ...
          <Card className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground">
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold mb-4">Need Help with Your Taxes?</h3>
              <p className="text-lg mb-6 opacity-90">
                Our experienced tax professionals are here to help you navigate complex tax situations and ensure compliance.
              </p>
